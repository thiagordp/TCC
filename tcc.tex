...
\newcommand{\figura}[5][Extraído de:]{
	\begin{figure}[h!tb]
		\centering
		\caption{#3.}
...
\titulo{Um modelo de geladeira aprimorado que facilite a vida dos usuário e que leva em conta suas preferências}
...
\coordenador[Coordenadora\\Universidade Federal de Santa Catarina]{Prof. Dr. Eliane Pozzebon} %TODO Rever o Coordenador do curso
