...
\coordenador[Coordenadora]{Profa. Dra. Eliane Pozzebon} %TODO Rever o Coordenador do curso
...
\bancaMembroA{Prof. Dr. Alexandre Leopoldo Gonçalves\\Universidade Federal de Santa Catarina} %Nome do presidente da banca
\bancaMembroB{Profa. Dra. Analúcia Schiaffino Morales\\Universidade Federal de Santa Catarina}      % Nome do membro da Banca
%\bancaMembroC{Prof. Dr. Anderson Luiz Fernandez Perez\\Universidade Federal de Santa Catarina}     % Nome do membro da Banca
\bancaMembroC{Profa. Dra. Olga Yevseyeva\\Universidade Federal de Santa Catarina}       % Nome do membro da Banca
%\bancaMembroE{Quinto membro\\Universidade ...}       % Nome do membro da Banca
%\bancaMembroF{Sexto membro\\Universidade ...}        % Nome do membro da Banca
%\bancaMembroG{Sétimo membro\\Universidade ...}       % Nome do membro da Banca

\include{pretextual/dedicatoria}
\include{pretextual/agradecimento}
\include{pretextual/epigrafe}
\include{pretextual/resumo_pt}
\include{pretextual/resumo_en}
...
\begin{document}
	...
	%folhaaprovacao
	\includepdf[pages=-, offset=0 0]{pretextual/ficha_catalografica}
...
%	\addcontentsline{toc}{chapter}{\listquadroname}
	...
	%########################################################
	% Elementos textuais
	\include{textual/cap_1_introducao}
	\include{textual/cap_2_internet_of_things}
	\include{textual/cap_3_sistemas_de_recomendacao}
	\include{textual/cap_4_sistema_proposto}
	\include{textual/cap_5_avalicao_sistema}
	\include{textual/cap_6_consideracoes_finais}
